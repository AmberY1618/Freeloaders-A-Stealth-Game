...
public class Clock : MonoBehaviour
{
    ...
    void UpdateTimer() {
       ...
       iTween.RotateTo(secondHand, iTween.Hash("z", secondsInt * 12 * -1, "time", 1, "easetype", "easeOutQuint"));
       iTween.RotateTo(minuteHand, iTween.Hash("z", minutesInt * 12 * -1, "time", 1, "easetype", "easeOutQuint"));

       float hourDistance = (float)(minutesInt) / 60f;
       iTween.RotateTo(hourHand, iTween.Hash("z", (hoursInt + hourDistance) * 360 / 12 * -1, "time", 1, "easetype", "easeOutElastic"));
